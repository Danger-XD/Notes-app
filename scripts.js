...
function addNote() {
  ...
  newNote.innerHTML = `
          <div class="control-btn">
            ...
            <!-- this hidden is for textarea so that is does not move down show-box -->
...
function deleteMode(note) {
  note.remove();
};

function editMode(note) {
  const textArea = note.querySelector(".textArea");
  const textDisplay = note.querySelector(".show-box");
